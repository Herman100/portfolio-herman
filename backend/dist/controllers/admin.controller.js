...
import { generateAccessToken, generateRefreshToken, } from "../middleware/admin.middleware.js";
...
const adminController = {
    ...
    register: asyncHandler(async (req, res) => {
        ...
        await newAdmin.save();
        // Send response
        res.status(201).json(new ApiResponse(201, "Admin registered successfully", "Admin registered successfully"));
    }),
    // Login admin
