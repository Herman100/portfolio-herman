...
router.post("/categories", verifyAccessToken, blogCategoryController.createCategory);
router.get("/categories", verifyAccessToken, blogCategoryController.getAllCategories);
router.get("/categories/public", blogCategoryController.getAllCategories);
router.get("/categories/:id", verifyAccessToken, blogCategoryController.getCategoryById);
router.put("/categories/:id", verifyAccessToken, blogCategoryController.updateCategory);
router.delete("/categories/:id", verifyAccessToken, blogCategoryController.deleteCategory);
// Tag Routes
